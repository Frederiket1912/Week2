 ...
 * @author frede
 */
@WebServlet(name = "RequestHeaderInfo", urlPatterns = {"/RequestHeaderInfo"})
public class RequestHeaderInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RequestHeaderInfo</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            out.println("<h1>Servlet RequestHeaderInfo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
